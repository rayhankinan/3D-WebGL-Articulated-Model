  ...
  return new Articulated(
    ...
    [
      new Animation(
        ...
        (c) => -50 * Math.abs(Math.sin(c))
      ),
      new Animation("left-leg", AnimationType.ROTATE_X, (c) => Math.sin(c)),
      new Animation("right-leg", AnimationType.ROTATE_X, (c) => -Math.sin(c)),
      new Animation(
        "left-calf",
        AnimationType.ROTATE_X,
        (c) => -Math.sin(c + 0.1) * 0.4
      ),
      new Animation(
        "right-calf",
        AnimationType.ROTATE_X,
      ...
      new Animation("waist", AnimationType.ROTATE_Y, (c) => Math.sin(c) * 0.4),
      new Animation("torso", AnimationType.ROTATE_Y, (c) => Math.sin(c) * 0.4),
      new Animation(
        "neck",
        AnimationType.ROTATE_Y,
        (c) => Math.sin(c + 0.25) * 0.4
      ),
      new Animation(
        "head",
        AnimationType.ROTATE_X,
